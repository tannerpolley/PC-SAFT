...
if __name__ == "__main__":
    ...
    d_MEACOO = []
    d_MEAH = []
    #list for enthalpy of liquid mixture
    HLf_40 = []
    HLf_80 = []
    HLf_120 = []
    HLi_40 = []
    ...
    for i in T:
        for j in range(len(LD)):
            ...
            if i == 40+273.15:
                ...
                HLf_40.append(value(-model.HL['fin']))
                HLi_40.append(value(-model.HL['ref']))
                #speciation
            ...
            if i == 80+273.15:
                ...
                HLf_80.append(value(-model.HL['fin']))
                HLi_80.append(value(-model.HL['ref']))
            if i == 120+273.15:
                p120.append(value(exp(model.lnPCO2['ref'])))
                Hex_120.append(value(-model.Hex['ref']))
                Habs_120.append(value(-model.Habs))
                HLf_120.append(value(-model.HL['fin']))
                HLi_120.append(value(-model.HL['ref']))
    ...
    #
    # lab1=ax1.plot(LD,Hex_40,linestyle="--",c='r',label='Hex at 40 C ')
    # lab2=ax1.plot(LD,Hex_80,linestyle="-",c='b',label='Hex at 80 C')
    # lab3=ax1.plot(LD,Hex_120,linestyle="-.",c='g',label='Hex at 120 C')
    #
